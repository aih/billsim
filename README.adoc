...
If one is running this on a m1 mac, it is suggested to run the following instructions 
...
If one gets the following error when trying to set up the virtual enviroment, below is the error and the way to remedy it
